...
<nav class="pager"><?php if ($page > 1): ?><a href="collection.php?page=<?= $page - 1 ?>">上一页</a><?php endif; ?><span>第 <?= $page ?> 页</span><?php if (count($items) === $perPage): ?><a href="collection.php?page=<?= $page + 1 ?>">下一页</a><?php endif; ?></nav>
